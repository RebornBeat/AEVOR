...
- **Verified:** aevor-execution 79 lib; node 56 lib + **25 e2e**; clippy 0 (`-p node --lib --tests`); benchmarks run with settlement inline, verify throughput unchanged with balance deltas shipped.
